...
A system for extracting structured knowledge from legal evidence documents using graph-based RAG (Retrieval-Augmented Generation). Designed to process the Epstein investigation document corpus.
...
## Building a Knowledge Graph to Map the Epstein Evidence
...
│   ├── ocr_quality_report.json # OCR quality metrics
│   ├── ocr_quality_report_final.json
│   ├── processed/              # OCR output JSON files
│   ├── extracted/              # Entity extraction JSON files
│   ├── processed_failed_backup/
│   ├── processed_gemini_backup/
│   └── comparison/
...
This project is for legal evidence analysis and research purposes.
